...
<<<<<<<< HEAD:src/vendors/staking-deposit-cli-2.3.0/staking_deposit/utils/constants.py
...
>>>>>>>> ethupstream/main:src/vendors/ethstaker-deposit-cli-0.6.0/ethstaker_deposit/utils/constants.py
})
