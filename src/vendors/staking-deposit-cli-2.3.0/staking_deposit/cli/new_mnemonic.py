...
def new_mnemonic(ctx: click.Context, mnemonic_language: str, **kwargs: Any) -> None:
    ...
    test_mnemonic = ''
<<<<<<<< HEAD:src/vendors/staking-deposit-cli-2.3.0/staking_deposit/cli/new_mnemonic.py
...
========
    ...
    try:  # Failing this on headless Linux is expected
        ...
        pass
>>>>>>>> ethupstream/main:src/vendors/ethstaker-deposit-cli-0.6.0/ethstaker_deposit/cli/new_mnemonic.py
